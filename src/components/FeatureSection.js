    ...
    <section className="py-16 px-4 md:px-8 lg:px-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex items-center mb-12 justify-center">
          ...
          <h2 className="text-2xl font-display font-bold text-white">Key Features of Aptos-Casino</h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center mb-16">
          ...
          <div className="lg:col-span-7 p-[1px] bg-gradient-to-r from-red-magic to-blue-magic rounded-xl">
            <div className="bg-[#1A0015] rounded-xl p-6 md:p-8">
              <h3 className="text-white/70 text-sm uppercase tracking-wider mb-3">Traditional vs Aptos-Casino</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="bg-[#250020] rounded-lg p-4 border-l-2 border-blue-400/50">
                  <h5 className="text-blue-magic font-medium mb-2">Aptos-Casino</h5>
                  <ul className="space-y-2 text-white/70 text-sm">
                    <li className="flex items-start">
              ...
              <p className="text-white/80 text-sm">
                Aptos-Casino leverages Aptos Blockchain to provide a transparent, provably fair gaming

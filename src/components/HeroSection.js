    ...
    >
      ...
      <div className={
        ...
        <h2 className="text-[#B3B3B3] mt-4 text-lg sm:text-xl leading-relaxed max-w-2xl">
          Dive into the next generation of gaming with Aptos-Casino – where every move is powered by <span className="text-white font-semibold">Aptos Blockchain</span>. Discover new games, connect

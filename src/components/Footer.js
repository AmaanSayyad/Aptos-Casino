          ...
          <div className="p-[1px] bg-gradient-to-r from-red-magic/40 to-blue-magic/40 rounded-lg mb-6 hover:from-red-magic hover:to-blue-magic transition-all duration-300">
            <div className="bg-[#120010] rounded-lg p-4">
              <p className="text-white/80 text-sm leading-relaxed">
                Aptos-Casino is your ultimate destination for Aptos gaming. Experience transparency, fairness,
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-sm text-white/50">
            © {new Date().getFullYear()} Aptos-Casino. All rights reserved.
          </div>
        ...
        <div className="text-xs text-white/30 text-center mt-6">
          Aptos-Casino encourages responsible gaming. Please play responsibly and only with funds you can afford to lose.
